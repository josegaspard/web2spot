<br><br>
<div id="ofertas" class="our-clients__title">
Nuestras ofertas
</div>
      ...
      <div class="our_solution_category">
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>Página Web + SEO</h3>
            </div>
            <div class="solu_description">
              <p>
                Contrato por 6 meses descuento de 20%, desde 169 soles ahorras 40 soles mensuales
              </p>
              <button class="read_more_btn">Conocer más</button>
            </div>
          </div>
        ...
        <div class="solution_cards_box sol_card_top_3">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>Página web + Estrategia de redes sociales</h3>
            </div>
            <div class="solu_description">
              <p>
                Por la compra de la estrategia emprende + 30 soles lleva una página web completa (ecommerce y servicio).
              </p>
              <button class="read_more_btn">Conocer más</button>
            </div>
          </div>
