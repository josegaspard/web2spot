<div class="hero-beginning">
    <div class="container">
        <div class="hero-beginning__left">
            <header class="hero-beginning__header">
                <?php include('raya.php'); ?>
                <h1 class="hero-beginning__title"><?php the_sub_field('title') ?></h1>
            </header>
            <p class="hero-beginning__content"><?php the_sub_field('text') ?></p>
            <div class="hero-beginning__btns">
                <button style="
                height: 50px;
                font-size: 13px;
                    max-width: 212px;
    ...
    color: white;" class="contact-section__btn btn btnModalInfo">Solicítalo aquí</button>
                <a href="#ofertas" style="color: white;">
                    <div class="btn hero-beginning__btn btn--transparent">
                    <p><?php the_sub_field('btn-2__text') ?></p>
                </div>
                </a>
            </div>
        </div>
        <div class="hero-beginning__right">
            <img src="<?php the_sub_field('img') ?>" alt="img" class="hero-beginning__img">
        </div>
        <?php include('openpay-wave.php'); ?>
    </div>
</div>
