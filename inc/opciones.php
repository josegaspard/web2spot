...
function page_ajustes(){
    add_menu_page('page','Spot Ajustes Generales','administrator','page_ajustes','page_ajustes_opciones','','20');
...
function page_registrar_opciones(){
    ...
    register_setting('page_ajustes_opciones_grupo', 'whatsapp_page');
      ...
      <h1>Datos de contacto</h1>
        ...
        <?php do_settings_sections('page_ajustes_opciones_grupo');?>
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row" style="font-family:'Lato'; font-weight:400;">Numero para whatsapp</th>
                    <td><input type="text" name="whatsapp_page"  style="min-width:300px;"  value="<?php echo  esc_attr(get_option('whatsapp_page'))?>"></td>
                </tr>
