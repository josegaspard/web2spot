...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() > 70) {
      ...
      if (!$('.single').length && !$('.articulo-principal').length) {
  ...
  $('.site-header-sandwich').click(function () {
    if ($('.site-header-sandwich').hasClass('active') && !$('.site-header').hasClass('actived')) {
      ...
      const brand = $('#brand').data('brandtwo');
  ...
  function addCarousel(element, index, number, mover, margin, itemstablet, loop, flechas, dots, autoplay, velocidad, animateIn, animateOut, autoWidth, slideBy, autoWidthMobile, margindesktop, URLhashListener, itemsDesktop) {
    if (!itemsDesktop) {
      itemsDesktop = itemstablet;
    }
  ...
  addCarousel('why-us__img', 0, 1, true, 0, 1, true, false, false, true, 3000, '', '', false, false, false, 0, '');
  addCarousel('servicios-slider__items', 0, 2, true, 0, 3, true, true, false, true, 3000, '', '', false, false, false, 0, '');
  addCarousel('plans-service-slider', 0, 1.1, true, 16, 3, true, true, false, true, 3000, '', '', false, false, false, 32);
  addCarousel('our-clients-slider', 0, 2, true, 16, 3, true, true, false, true, 3000, '', '', false, false, false, 32);
  addCarousel('quote-slider', 'URLHash', 1, true, 0, 1, false, false, true, false, 3000, '', '', false, false, false, 0, true);
  ...
  addCarousel('hero-container', 0, 1, true, 0, 1, true, true, false, true, 5000); // addCarousel('our-team__slider', 0, 1, true, 10, 1, true, true, false, true, 3000, '', false, false, 1, false, 120)

  addCarousel('our-team__slider', 0, 1, true, 16, 2, true, true, false, true, 3000, '', '', false, 2, false, 32, 2);
